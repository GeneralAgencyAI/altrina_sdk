"""Custom exceptions for the Altrina SDK."""

from typing import Optional, Dict, Any


class AltrinaError(Exception):
    """Base exception for all Altrina SDK errors."""
...
class AuthenticationError(AltrinaError):
...
class RateLimitError(AltrinaError):
...
class JobNotFoundError(AltrinaError):
...
class JobFailedError(AltrinaError):
...
class ValidationError(AltrinaError):
...
class TimeoutError(AltrinaError):
...
class ConfigurationError(AltrinaError):
